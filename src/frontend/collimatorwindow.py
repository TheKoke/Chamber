...
class Ui_CollimatorWindow(object):
    def setupUi(self, CollimatorWindow):
        ...
        self.diameter_layout.setObjectName("diameter_layout")
        self.diameter_label = QLabel(self.info_layout)
        self.diameter_label.setMaximumSize(QSize(16777215, 40))
        self.diameter_label.setAlignment(Qt.AlignCenter)
        self.diameter_label.setObjectName("diameter_label")
        self.diameter_layout.addWidget(self.diameter_label)
        ...
        self.diameter_layout.addWidget(self.diameter_box)
        self.properties_layout.addLayout(self.diameter_layout)
    ...
    def retranslateUi(self, DetectorWindow):
        ...
        self.diameter_label.setText(_translate("CollimatorWindow", "R:"))
...
class CollimatorWindow(QDialog, Ui_CollimatorWindow):
    ...
    def set_values(self) -> None:
        ...
        self.diameter_box.setValue(self.collimator.diameter)
