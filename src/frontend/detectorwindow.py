...
class Ui_DetectorWindow(object):
    ...
    def retranslateUi(self, DetectorWindow):
        ...
        DetectorWindow.setWindowTitle(_translate("DetectorWindow", "Detector Settings - Chamber"))
...
class DetectorWindow(QDialog, Ui_DetectorWindow):
    ...
    def set_values(self) -> None:
        self.xcoord_box.setValue(self.detector.x_position)
        self.ycoord_box.setValue(self.detector.y_position)
        self.zcoord_box.setValue(self.detector.z_position)
